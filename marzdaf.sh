#!/bin/bash
sfile="https://github.com/aixxycode/nissa/blob/main"

# Change Repo Id Debian 11/12
wget -O /root/repoid https://raw.githubusercontent.com/aixxycode/nissa/main/repositoryid && chmod +x /root/repoid && /root/repoid && rm -f /root/repoid
...
wget -O /var/lib/marzban/xray_config.json https://raw.githubusercontent.com/aixxycode/nissa/main/xray_config.json

# Download .env
wget -O /opt/marzban/.env https://raw.githubusercontent.com/aixxycode/nissa/main/env

# Download Subscription
sudo wget -N -P /var/lib/marzban/templates/subscription/  https://raw.githubusercontent.com/aixxycode/nissa/main/index.html

# Download Sqlite3
wget -O /var/lib/marzban/db.sqlite3 https://raw.githubusercontent.com/aixxycode/nissa/main/db.sqlite3
...
# Download Geositemod
wget -O /root/geositemod https://raw.githubusercontent.com/aixxycode/nissa/main/geositemod && chmod +x /root/geositemod && /root/geositemod && rm -f /root/geositemod

# Fix Marzban error log
wget -O /usr/local/bin/fixmarzban https://raw.githubusercontent.com/aixxycode/nissa/main/fixnodeusage && \
wget -O /etc/systemd/system/fix.service https://raw.githubusercontent.com/aixxycode/nissa/main/fix.service && \
...
# Install cek service
wget -O /root/.bash_profile https://raw.githubusercontent.com/aixxycode/nissa/main/profile && \
wget -O /usr/bin/cek https://raw.githubusercontent.com/aixxycode/nissa/main/cek && \
chmod +x /usr/bin/cek
